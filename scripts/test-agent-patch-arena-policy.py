...
assert MODULE.classify_change(["src/vortex/oauth.ts"]) == "security"
assert MODULE.classify_change(["bench/foo.ts"]) == "performance"
...
assert MODULE.classify_change([
    ".github/workflows/agent-patch-arena.yml",
    "src/vortex/server.ts",
]) == "mixed"
assert MODULE.classify_change([
    "scripts/agent-patch-arena.py",
    "src/vortex/server.ts",
]) == "mixed"
assert MODULE.classify_change(["bench/foo.ts", "src/vortex/server.ts"]) == "mixed"
assert MODULE.classify_change(["src/vortex/server.ts", "tests/server.test.ts"]) == "mixed"
assert MODULE.classify_change([]) == "correctness"
